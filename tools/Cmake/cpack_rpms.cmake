...
if(DEFINED ENV{ARCH})
    ...
    if(CPACK_RPM_PACKAGE_ARCHITECTURE MATCHES "/")
...
set(CPACK_RPM_PACKAGE_NAME "appimagespec")
set(CPACK_RPM_PACKAGE_SUMMARY
    "Optional AppImagespec daemon for desktop integration. Integrates AppImages into the desktop, e.g., installs icons and menu entries.")
